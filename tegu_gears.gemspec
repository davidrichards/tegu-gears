...
Gem::Specification.new do |s|
  ...
  s.files = ["VERSION.yml", "lib/examples", "lib/examples/factorial.rb", "lib/examples/fibonacci.rb", "lib/tegu_gears", "lib/tegu_gears/memoize.rb", "lib/tegu_gears.rb", "spec/lib", "spec/lib/examples", "spec/lib/examples/factorial_spec.rb", "spec/lib/examples/fibonacci_spec.rb", "spec/lib/tegu_gears", "spec/lib/tegu_gears/memoize_spec.rb", "spec/spec_helper.rb", "spec/tegu_gears_spec.rb"]
  s.has_rdoc = true
